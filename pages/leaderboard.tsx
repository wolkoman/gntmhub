      ...
      <div className="max-w-xl mx-auto">
        <div className="flex flex-col justify-center">
          ...
          <div className="grid grid-cols-2 gap-2">
            {users[1] ? <div
              className="flex w-full p-4 rounded self-center bg-gray-300 dark:bg-gray-700 items-center text-lg transform lg:scale-105 lg:-ml-3 my-1">
            ...
            {users.slice(3).map((user, i) => (
              <div key={user.name} className="flex p-3 rounded justify-center bg-gray-100 dark:bg-gray-800">
