    ...
    <Site>
      <div className="flex flex-row mb-4">
        <div className="flex flex-col md:flex-row justify-end flex-grow dark:text-gray-200">
          <Link href="/finale">
            <div
              className="bg-gray-100 dark:bg-gray-800 px-8 py-2 rounded mb-2 md:mb-0 mr-2 flex-grow flex items-center lg:text-lg cursor-pointer underline hover:no-underline">
