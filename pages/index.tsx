      ...
      <div className="flex bg-gray-100 dark:bg-gray-800">
        ...
        <div className="w-full max-w-2xl px-4 mt-16">
          ...
          <div className="font-serif text-2xl py-2">
            Die virtuelle, just-for-fun Plattform zu der Casting-Serie „Germanys Next
            Topmodel“ mit Aktienhandel, Bonusfragen und Ranglisten.
          </div>
          ...
          <div className="flex my-8">
            <Link href={Route.LOGIN}>
              <div
                className="px-4 py-2 text-lg bg-white text-pohutukawa-400 font-bold rounded mr-4 cursor-pointer">
                Login
              </div>
            </Link>
