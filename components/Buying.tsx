...
export function Buying(props: { selected: string, onClose: () => any }) {
    ...
    return <div className="relative h-full flex p-6">
        <div className="flex flex-col grow lg:flex-row justify-end lg:justify-between items-start space-y-4 lg:space-y-0 w-full h-full overflow-y-scroll">
            ...
            <BuyingPanel candidate={candidate}/>
        </div>
        <div
            className={
